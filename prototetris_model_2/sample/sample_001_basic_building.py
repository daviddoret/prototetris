...
p = []
p.append(sympy_polygon_to_vtk_polydata(g))
p.append(sympy_polygon_to_vtk_polydata(b))
p.append(sympy_polygon_to_vtk_polydata(fb))
p.append(sympy_polygon_to_vtk_polydata(f1))
p.append(sympy_polygon_to_vtk_polydata(f2))
